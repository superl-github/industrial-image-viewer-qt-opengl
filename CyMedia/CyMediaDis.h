/**
* @file CyMediaDis.h
* @brief CyMediaDis头文件，对外API
* @ingroup Display
*
* @details
*  包含高性能图像显示交互集成组件`CyMedia::CyMediaDis`与文件头信息获取窗口`CyMedia::CyMediaDis_GetRawInfoDialog`
* 
* @author LLF
* @version 1.2.3
*/
...
namespace CyMedia {
     ...
     * @see CyMediaDisView, CyMediaDisViewBckDraw, CyMediaDisViewThumbnail
     */
